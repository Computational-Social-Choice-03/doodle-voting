...
agents_9_thresholdA_60_D20_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_60_D20_utils_avg))
...
agents_9_thresholdA_60_D30_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_60_D30_utils_avg))
...
agents_9_thresholdA_60_D40_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_60_D40_utils_avg))
...
agents_9_threshold_A60_avg$x <- seq.int(nrow(agents_9_threshold_A60_avg))
...
agents_9_thresholdA_70_D20_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_70_D20_utils_avg))
...
agents_9_thresholdA_70_D30_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_70_D30_utils_avg))
...
agents_9_thresholdA_70_D40_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_70_D40_utils_avg))
...
agents_9_threshold_A70_avg$x <- seq.int(nrow(agents_9_threshold_A70_avg))
...
agents_9_thresholdA_80_D20_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_80_D20_utils_avg))
...
agents_9_thresholdA_80_D30_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_80_D30_utils_avg))
...
agents_9_thresholdA_80_D40_utils_avg$x <- seq.int(nrow(agents_9_thresholdA_80_D40_utils_avg))
...
agents_9_threshold_A80_avg$x <- seq.int(nrow(agents_9_threshold_A80_avg))
...
ggplot(data=agents_9_all_utils, aes(x=x, y=y, group=row, scale_size(guide = "none"))) +
  ...
  geom_line(data=agents_9_threshold_A60_avg,aes(x=x,y=y),color="#0077ff",size=2,alpha=0.8) +
  geom_line(data=agents_9_threshold_A70_avg,aes(x=x,y=y),color="#0053b3",size=2,alpha=0.8) +
  geom_line(data=agents_9_threshold_A80_avg,aes(x=x,y=y),color="#002880",size=2,alpha=0.8) +
